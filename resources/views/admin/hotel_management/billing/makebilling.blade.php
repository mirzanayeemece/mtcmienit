                ...
                <form class="" action="{{ url('/savebilling') }}" method="post" enctype="multipart/form-data" style="padding: 0 30px 0 30px;">
                  ...
                  <p class="alert-success" style="font-size: 20px; color: white; background:#149278; padding: 0 30px 0 30px;">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                      <input type="text" class="form-control" id="booking_id" name="booking_id" value="{{ $book_info->id }}" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                      <input type="text" class="form-control datepicker" id="start_date" name="start_date" autocomplete="off" value="{{ $book_info->start_date }}" required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control datepicker" id="end_date" name="end_date" value="{{ $book_info->end_date }}" autocomplete="off" required>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6">
                        ...
                        @foreach($room_info as $row_room)
                            @if($row_room->id == $book_info->room_id)
                                <input type="text" class="form-control" id="room_id" name="room_id" value="{{ $row_room->room_no }}" autocomplete="off" required>
                            @endif
                        @endforeach
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control" id="advance_pay" name="advance_pay" autocomplete="off" required>
                      </div>
                    </div>

                    <div class="form-group row">
                      <label for="total_pay" class="col-md-4 col-form-label text-md-left">Total Payment:</label>
                      <div class="col-md-6">
                        <input type="text" class="form-control" id="total_pay" name="total_pay" autocomplete="off" required>
                      </div>
                    </div>
