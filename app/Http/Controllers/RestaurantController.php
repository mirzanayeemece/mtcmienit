...
//------- METHODS FOR GROCERY-CATEGORY --------//
    ...
    {
        $this->validate($request, [
          'name'  => ['required', 'string', 'max:100','unique:grocery_categories'],
          'description'  => ['max:255'],
        ...
        DB::table('grocery_categories')->insert($data);
    ...
    {
        $grocery_category=DB::table('grocery_categories')
                           ->where('id',$id)
                           ->first();
    ...
    public function grocery(){
        $grocery_info=DB::table('groceries')
                            ->orderBy('id', 'desc')
                            ->get();
        $grocery_category_info=DB::table('grocery_categories')
                            ->orderBy('id', 'desc')
...
//------- METHODS FOR MEAL-ITEM-TYPE --------//
    ...
    public function meal_item_type(){
        $meal_item_type_info=DB::table('meal_types')
                           ->orderBy('id', 'desc')
                           ->get();
    ...
    {
        $this->validate($request, [
          'name'  => ['required', 'string', 'max:100','unique:meal_types'],
          'description'  => ['max:255']
    ...
    {
        $meal_item_type=DB::table('meal_types')
                           ->where('id',$id)
                           ->first();
...
//------- METHODS FOR MEAL-ITEM --------//
    ...
    {
        $this->validate($request, [
          'name'  => ['required', 'string', 'max:100','unique:meal_items'],
        ...
        DB::table('meal_items')->insert($data);
...
//------- METHODS FOR MENU-TYPE --------//
    ...
    {
        $this->validate($request, [
          'name'  => ['required', 'string', 'max:100','unique:menu_types'],
          'description'  => ['max:255'],
