            ...
            <div class="card">
              ...
              <form class="" action="{{ url('/save_inventory_item') }}" method="post" enctype="multipart/form-data" style="padding: 0 30px 0 30px;">
                ...
                <div class="form-group row">
                    <label for="name" class="col-md-4 col-form-label text-md-left">Inventory Name:</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                  <label for="inventory_category_id" class="col-md-4 col-form-label text-md-left">Category Name:</label>
                  <div class="col-md-6">
