        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="text" class="form-control" value="{{$employee->phone}}" id="phone" name="phone" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                      <input type="text" class="form-control" value="{{$employee->emergency_contact}}" id="emergency_contact" name="emergency_contact" required>
                    </div>
                </div>
